...
6. Add your [Builder API Key from the Builder Console](/solutions/builder/getting-started#step-3-optional-for-development-claim-an-api-access-key) under `Settings > API Access Keys` - you want the `prod` key

...
<Callout type='danger'>
  If you require a server private key, you can use [this application](https://73eql-hyaaa-aaaad-qf5bq-cai.ic.fleek.co/) to generate a local wallet, and copy the private key into your code
</Callout>
...
Follow [this video walk through](/solutions/builder/project-management) to create a project

### Upgrade Billing to Developer, from Community

Follow [this walk through](/solutions/builder/project-settings#update-your-project-subscription-plan) to upgrade your billing to at least `Developer` tier
::::
...
Follow [this walk through](/solutions/builder/gas-tank) to sponsor your contract
::::

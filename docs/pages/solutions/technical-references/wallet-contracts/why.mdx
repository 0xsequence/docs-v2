...
In order for smart contract wallet's to be deployed on-chain, a fee is involved which varies across the various account abstraction providers.

From a list of account abstraction providers found [here](https://github.com/ScreamingHawk/aa-benchmarks), Sequence ranks as the lowest total fee to deploy required for users to make their first transaction on-chain.

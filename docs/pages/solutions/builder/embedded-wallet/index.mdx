...
- [Login Providers](/solutions/builder/embedded-wallet#login-providers)
- [Allowed Origins](/solutions/builder/embedded-wallet#allowed-origins)
- [Recovery Wallet](/solutions/builder/embedded-wallet#recovery-wallet)
- [Parent Wallet](/solutions/builder/embedded-wallet#parent-wallet)
- [SDK Integrations](/solutions/builder/embedded-wallet#sdk-integrations)
...
- Guard - fully owned by Sequence
- Authenticator - jointly owned by Sequence and Quantstamp

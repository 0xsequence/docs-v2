...
### 3: (Optional for Development) Claim an API Access Key
...
![copy access key](/img/builder/builder_settings_copy_key.png)
...
### 4. (Optional for Development) Create a Service Account

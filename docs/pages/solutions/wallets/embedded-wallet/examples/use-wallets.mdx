...
- [**Wallet Access**](/solutions/wallets/embedded-wallet/examples/use-wallets#wallet-address): Access the wallet linked to the user's authenticated account. This wallet serves as the gateway to all account functions.
- [**Social Identifiers**](/solutions/wallets/embedded-wallet/examples/use-wallets#authenticated-email-address): Access the email linked to the user's authenticated account. This email is only available upon authenticating a session.

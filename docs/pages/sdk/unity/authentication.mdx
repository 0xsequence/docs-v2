...
Note: Email sign in is not available to projects on the Community tier in the Builder. You will need to add `Email` as a login option when [setting up your embedded wallet in the Builder Console](/solutions/builder/embedded-wallet). For more info on upgrading your Builder Project Subscription Plan, please [see here](/solutions/builder/project-settings/#5-billing-settings).
